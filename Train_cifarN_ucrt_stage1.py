...
parser.add_argument('--noise_mode', default='rand2')
...
args.noise_mode = noise_type_map[args.noise_mode]
...
if __name__ == '__main__':
    ...
    loader = dataloader.cifar_dataloader(args.dataset, noise_mode=args.noise_mode, batch_size=args.batch_size,
                                         num_workers=0,
    ...
    for epoch in range(resume_epoch, args.num_epochs + 1):
        ...
        if epoch < warm_up:
            ...
            print('Train Net1')
            labeled_trainloader, unlabeled_trainloader, _ = loader.run('train', pred1, prob1)  # co-divide
            ...
            print('\nTrain Net2')
            labeled_trainloader, unlabeled_trainloader, u_map_trainloader = loader.run('train', pred2, prob2)  # co-divide
