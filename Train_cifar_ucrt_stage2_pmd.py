...
def Calculate_JSD(model1, model2):
    ...
    prob[prob < 0.5] = 0
    prob[idx_superclean] = 0
    pred_idx[idx_superclean] = True
...
if __name__ == '__main__':
    ...
    ckpt_sc = torch.load(
        './checkpoint/%s/hcs_%s_%.2f_%s_cn%d_run%d.pth.tar' % (
        exp_str111, args.dataset, args.r, args.noise_mode, args.num_clean, args.run))
